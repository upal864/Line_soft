...
samples = [
    ...
    {
        "text": "बोरीवली (वे) स्टेशन के पास गार्डभर्ती 12 घंटा ड्यूटी- वेतन गार्ड- 22,000, সুপারवाईजर- 26,000/- (आयु- 45 वर्ष के अंदर) (महिने का 4 छुट्टी) संपर्क : 9324254338/ 8169833371",
        "expected": 5
    },
    {
...
for gen in range(1000):
    ...
    while len(next_gen) < population_size:
        ...
        if random.random() < 0.2:
            child_max_w += random.randint(-10, 10)
